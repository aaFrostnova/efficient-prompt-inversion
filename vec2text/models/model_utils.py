...
def load_embedder_and_tokenizer(name: str, torch_dtype: str, **kwargs):
    ...
    if name == "CLIPTextModel":
        model = transformers.CLIPTextModel.from_pretrained("stable-diffusion-v1-5/text_encoder")
        tokenizer = transformers.CLIPTokenizer.from_pretrained("stable-diffusion-v1-5/tokenizer")
    elif name == "dpr":
...
def load_encoder_decoder(
    ...
    return transformers.AutoModelForSeq2SeqLM.from_pretrained(
        model_name, **model_kwargs, cache_dir='./.cache'
    )
